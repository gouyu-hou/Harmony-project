...
// 完整静态数据
export const cityData: ProvinceNode[] = [

  {
    ...
    cities: [
      ...
      { name: "东莞市", districts: ["东城街道", "南城街道", "万江街道", "莞城街道", "石杰镇", "石龙镇", "茶山镇", "石排镇", "企石镇", "横沥镇", "桥头镇", "谢岗镇", "东坑镇", "常平镇", "寮步镇", "樟木头镇", "大朗镇", "黄江镇", "清溪镇", "塘厦镇", "凤岗镇", "大岭山镇", "长安镇", "虎门镇", "厚街镇", "沙田镇", "道滘镇", "洪梅镇", "麻涌镇", "望牛墩镇", "中堂镇", "高埗镇"] },
      { name: "中山市", districts: ["石岐街道", "东区街道", "西区街道", "南区街道", "五桂山街道", "中山港街道", "黄圃镇", "南头镇", "东凤镇", "阜沙镇", "小榄镇", "东升镇", "古镇镇", "横栏镇", "三角镇", "民众镇", "南朗镇", "港口镇", "大涌镇", "沙溪镇", "三乡镇", "板芙镇", "神湾镇", "坦洲镇"] },
...

  {
    ...
    cities: [
      ...
      { name: "邢台市", districts: ["襄都区", "信都区", "任泽区", "南和区", "内丘县", "临城县", "隆尧县", "柏乡县", "宁晋县", "巨鹿县", "新河县", "广宗县", "平乡县", "威县", "清河县", "临西县", "南宫市", "沙河市"] },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "四平市", districts: ["铁西区", "铁东区", "梨树县", "伊通满族自治县", "双辽市"] },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "伊春市", districts: ["伊美区", "乌翠区", "友好区", "金林区", "嘉荫县", "汤旺县", "丰林县", "大箐山县", "南岔县", "铁力市"] },
      ...
      { name: "大兴安岭地区", districts: ["漠河市", "呼玛县", "塔河县"] }
    ]
  },
  {
    province: "上海市",
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "宁波市", districts: ["海曙区", "江北区", "镇海区", "北仑区", "鄞州区", "奉化区", "象山县", "宁海县", "余姚市", "慈溪市"] },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "安庆市", districts: ["迎江区", "大观区", "宜秀区", "怀宁县", "潜山市", "太湖县", "宿松县", "望江县", "岳西县", "桐城市"] },
      ...
      { name: "宣城市", districts: ["宣州区", "郎溪县", "广德市", "宁国市", "泾县", "绩溪县", "旌德县"] }
    ]
  },
  {
    province: "福建省",
    cities: [
      ...
      { name: "泉州市", districts: ["鲤城区", "丰泽区", "洛江区", "泉港区", "惠安县", "安溪县", "永春县", "德化县", "石狮市", "晋江市", "南安市"] },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "赣州市", districts: ["章贡区", "南康区", "赣县区", "信丰县", "大余县", "上犹县", "崇义县", "安远县", "龙南市", "定南县", "全南县", "宁都县", "于都县", "兴国县", "会昌县", "寻乌县", "石城县", "瑞金市"] },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "洛阳市", districts: ["老城区", "西工区", "瀍河回族区", "涧西区", "洛龙区", "孟津区", "偃师区", "新安县", "栾川县", "嵩县", "汝阳县", "宜阳县", "洛宁县", "伊川县"] },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "荆门市", districts: ["东宝区", "掇刀区", "沙洋县", "京山市", "钟祥市"] },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "永州市", districts: ["零陵区", "冷水滩区", "祁阳市", "东安县", "双牌县", "道县", "江永县", "宁远县", "蓝山县", "新田县", "江华瑶族自治县"] },
...

  {
    ...
    cities: [
      ...
      { name: "百色市", districts: ["右江区", "田阳区", "田东县", "平果市", "德保县", "那坡县", "凌云县", "乐业县", "田林县", "西林县", "隆林各族自治县", "靖西市"] },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "省直辖县级行政单位", districts: ["五指山市", "琼海市", "文昌市", "万宁市", "东方市", "定安县", "屯昌县", "澄迈县", "临高县", "白沙黎族自治县", "昌江黎族自治县", "乐东黎族自治县", "陵水黎族自治县", "保亭黎族苗族自治县", "琼中黎族苗族自治县"] }
    ]
  },
  {
    province: "重庆市",
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "凉山彝族自治州", districts: ["西昌市", "会理市", "木里藏族自治县", "盐源县", "德昌县", "会东县", "宁南县", "普格县", "布拖县", "金阳县", "昭觉县", "喜德县", "冕宁县", "越西县", "甘洛县", "美姑县", "雷波县"] }
    ]
  },
  {
    province: "贵州省",
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "红河哈尼族彝族自治州", districts: ["个旧市", "开远市", "蒙自市", "弥勒市", "屏边苗族自治县", "建水县", "石屏县", "泸西县", "元阳县", "红河县", "金平苗族瑶族傣族自治县", "绿春县", "河口瑶族自治县"] },
      ...
      { name: "德宏傣族景颇族自治州", districts: ["芒市", "梁河县", "盈江县", "陇川县", "瑞丽市"] },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "林芝市", districts: ["巴宜区", "工布江达县", "米林市", "墨脱县", "波密县", "察隅县", "朗县"] },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "海西蒙古族藏族自治州", districts: ["格尔木市", "德令哈市", "茫崖市", "乌兰县", "都兰县", "天峻县"] }
    ]
  },
  {
    province: "宁夏回族自治区",
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "自治区直辖县级行政单位", districts: ["石河子市", "阿拉尔市", "图木舒克市", "五家渠市", "北屯市", "铁门关市", "双河市", "可克达拉市", "昆玉市", "胡杨河市", "新星市", "白杨市"] }
    ]
  },
  {
    province: "台湾省",
    cities: [
      ...
      { name: "新北市", districts: ["板桥区", "三重区", "中和区", "永和区", "新庄区", "新店区", "树林区", "莺歌区", "三峡区", "淡水区", "汐止区", "瑞芳区", "土城区", "芦洲区", "五股区", "泰山区", "林口区", "深坑区", "石碇区", "坪林区", "三芝区", "石门区", "八里区", "平溪区", "双溪区", "贡寮区", "金山区", "万里区", "乌来区"] },
      { name: "桃园市", districts: ["桃园区", "中路区", "龟山区", "八德区", "大溪区", "芦竹区", "大园区", "平镇区", "杨梅区", "龙潭区", "新屋区", "观音区", "复兴区"] },
      ...
      { name: "高雄市", districts: ["楠梓区", "左营区", "鼓山区", "三民区", "盐埕区", "前金区", "新兴区", "苓雅区", "前镇区", "旗津区", "小港区", "凤山区", "大寮区", "鸟松区", "林园区", "仁武区", "大树区", "大社区", "冈山区", "路竹区", "桥头区", "梓官区", "弥陀区", "永安区", "燕巢区", "田寮区", "阿莲区", "湖内区", "茄萣区", "旗山区", "美浓区", "内门区", "杉林区", "甲仙区", "六龟区", "茂林区", "桃源区", "那玛夏区"] },
  ...
  },
  {
    ...
    cities: [
      {
        districts: ["中西区", "湾仔区", "东区", "南区", "油尖旺区", "深水埗区", "九龙城区", "黄大仙区", "观塘区", "北区", "大埔区", "沙田区", "西贡区", "荃湾区", "屯门区", "元朗区", "葵青区", "离岛区"]
      }
    ]
  },
  {
    ...
    cities: [
      {
        districts: ["花地玛堂区", "圣安多尼堂区", "大堂区", "望德堂区", "风顺堂区", "嘉模堂区", "圣方济各堂区"]
      }
    ]
  }
];